...
s('t','<c-d>','<c-\\><c-n><cmd>vsplit term://nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
s('t','<c-s>','<c-\\><c-n><cmd>split term://nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
s('n','<a-cr>','<cmd>w<cr><cmd>10 split term://nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
s('i','<a-cr>','<esc><cmd>w<cr><cmd>10 split term://nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
s('n','<a-e>','<cmd>terminal nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
s('i','<a-e>','<esc><cmd>terminal nu<cr><cmd>lua vim.wo.number = false<cr><cmd>lua vim.wo.relativenumber = false<cr>i',o)
